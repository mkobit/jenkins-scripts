...
extra["jenkinsPluginArtifacts"] = mapOf(
  ...
  "blueocean" to mapOf("group" to "io.jenkins.blueocean", "name" to "blueocean", "version" to "1.2.4"),
  "blueocean-autofavorite" to mapOf("group" to "org.jenkins-ci.plugins", "name" to "blueocean-autofavorite", "version" to "1.0.0"),
  "blueocean-bitbucket-pipeline" to mapOf("group" to "io.jenkins.blueocean", "name" to "blueocean-bitbucket-pipeline", "version" to "1.2.4"),
  "blueocean-commons" to mapOf("group" to "io.jenkins.blueocean", "name" to "blueocean-commons", "version" to "1.2.4"),
  "blueocean-config" to mapOf("group" to "io.jenkins.blueocean", "name" to "blueocean-config", "version" to "1.2.4"),
  "blueocean-dashboard" to mapOf("group" to "io.jenkins.blueocean", "name" to "blueocean-dashboard", "version" to "1.2.4"),
  "blueocean-display-url" to mapOf("group" to "org.jenkins-ci.plugins", "name" to "blueocean-display-url", "version" to "2.1.0"),
  "blueocean-events" to mapOf("group" to "io.jenkins.blueocean", "name" to "blueocean-events", "version" to "1.2.4"),
  "blueocean-git-pipeline" to mapOf("group" to "io.jenkins.blueocean", "name" to "blueocean-git-pipeline", "version" to "1.2.4"),
  "blueocean-github-pipeline" to mapOf("group" to "io.jenkins.blueocean", "name" to "blueocean-github-pipeline", "version" to "1.2.4"),
  "blueocean-i18n" to mapOf("group" to "io.jenkins.blueocean", "name" to "blueocean-i18n", "version" to "1.2.4"),
  "blueocean-jira" to mapOf("group" to "io.jenkins.blueocean", "name" to "blueocean-jira", "version" to "1.2.4"),
  "blueocean-jwt" to mapOf("group" to "io.jenkins.blueocean", "name" to "blueocean-jwt", "version" to "1.2.4"),
  "blueocean-personalization" to mapOf("group" to "io.jenkins.blueocean", "name" to "blueocean-personalization", "version" to "1.2.4"),
  "blueocean-pipeline-api-impl" to mapOf("group" to "io.jenkins.blueocean", "name" to "blueocean-pipeline-api-impl", "version" to "1.2.4"),
  "blueocean-pipeline-editor" to mapOf("group" to "io.jenkins.blueocean", "name" to "blueocean-pipeline-editor", "version" to "1.2.4"),
  "blueocean-pipeline-scm-api" to mapOf("group" to "io.jenkins.blueocean", "name" to "blueocean-pipeline-scm-api", "version" to "1.2.4"),
  "blueocean-rest" to mapOf("group" to "io.jenkins.blueocean", "name" to "blueocean-rest", "version" to "1.2.4"),
  "blueocean-rest-impl" to mapOf("group" to "io.jenkins.blueocean", "name" to "blueocean-rest-impl", "version" to "1.2.4"),
  "blueocean-web" to mapOf("group" to "io.jenkins.blueocean", "name" to "blueocean-web", "version" to "1.2.4"),
  ...
  "docker-workflow" to mapOf("group" to "org.jenkins-ci.plugins", "name" to "docker-workflow", "version" to "1.13"),
  "durable-task" to mapOf("group" to "org.jenkins-ci.plugins", "name" to "durable-task", "version" to "1.14"),
  "email-ext" to mapOf("group" to "org.jenkins-ci.plugins", "name" to "email-ext", "version" to "2.60"),
  ...
  "git" to mapOf("group" to "org.jenkins-ci.plugins", "name" to "git", "version" to "3.6.0"),
  ...
  "github-api" to mapOf("group" to "org.jenkins-ci.plugins", "name" to "github-api", "version" to "1.89"),
  ...
  "job-dsl" to mapOf("group" to "org.jenkins-ci.plugins", "name" to "job-dsl", "version" to "1.65"),
  ...
  "jquery" to mapOf("group" to "org.jenkins-ci.plugins", "name" to "jquery", "version" to "1.11.2-1"),
  ...
  "maven-plugin" to mapOf("group" to "org.jenkins-ci.main", "name" to "maven-plugin", "version" to "3.0-rc2"),
  "mercurial" to mapOf("group" to "org.jenkins-ci.plugins", "name" to "mercurial", "version" to "2.1"),
  ...
  "pipeline-model-api" to mapOf("group" to "org.jenkinsci.plugins", "name" to "pipeline-model-api", "version" to "1.2.1"),
  ...
  "pipeline-model-definition" to mapOf("group" to "org.jenkinsci.plugins", "name" to "pipeline-model-definition", "version" to "1.2.1"),
  "pipeline-model-extensions" to mapOf("group" to "org.jenkinsci.plugins", "name" to "pipeline-model-extensions", "version" to "1.2.1"),
  ...
  "pipeline-stage-tags-metadata" to mapOf("group" to "org.jenkinsci.plugins", "name" to "pipeline-stage-tags-metadata", "version" to "1.2.1"),
  ...
  "pipeline-utility-steps" to mapOf("group" to "org.jenkins-ci.plugins", "name" to "pipeline-utility-steps", "version" to "1.4.1"),
  "plain-credentials" to mapOf("group" to "org.jenkins-ci.plugins", "name" to "plain-credentials", "version" to "1.4"),
  "promoted-builds" to mapOf("group" to "org.jenkins-ci.plugins", "name" to "promoted-builds", "version" to "2.29.1"),
  ...
  "scm-api" to mapOf("group" to "org.jenkins-ci.plugins", "name" to "scm-api", "version" to "2.2.2"),
  ...
  "ssh-slaves" to mapOf("group" to "org.jenkins-ci.plugins", "name" to "ssh-slaves", "version" to "1.21"),
  ...
  "workflow-api" to mapOf("group" to "org.jenkins-ci.plugins.workflow", "name" to "workflow-api", "version" to "2.22"),
  ...
  "workflow-durable-task-step" to mapOf("group" to "org.jenkins-ci.plugins.workflow", "name" to "workflow-durable-task-step", "version" to "2.15"),
  "workflow-job" to mapOf("group" to "org.jenkins-ci.plugins.workflow", "name" to "workflow-job", "version" to "2.14.1"),
  ...
  "workflow-support" to mapOf("group" to "org.jenkins-ci.plugins.workflow", "name" to "workflow-support", "version" to "2.15"),
...
extra["jenkinsPluginDependencies"] = mapOf(
  ...
  "blueocean" to setOf("pipeline-build-step", "blueocean-display-url", "blueocean-web", "blueocean-jwt", "blueocean-commons", "blueocean-github-pipeline", "blueocean-i18n", "blueocean-pipeline-api-impl", "blueocean-pipeline-editor", "blueocean-config", "pipeline-milestone-step", "blueocean-autofavorite", "blueocean-dashboard", "blueocean-rest-impl", "blueocean-events", "blueocean-bitbucket-pipeline", "blueocean-personalization", "blueocean-git-pipeline", "blueocean-jira", "blueocean-rest"),
  ...
  "blueocean-github-pipeline" to setOf("blueocean-pipeline-api-impl", "github-branch-source", "pubsub-light"),
  ...
  "blueocean-rest-impl" to setOf("blueocean-jwt", "blueocean-rest", "blueocean-web", "cloudbees-folder", "credentials", "junit", "mailer", "scm-api", "ssh-credentials", "favorite"),
  ...
  "pipeline-utility-steps" to setOf("workflow-step-api", "workflow-cps", "script-security"),
