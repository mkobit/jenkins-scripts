...
extra["jenkinsCoreVersion"] = "2.138.3"
...
extra["jenkinsPluginArtifacts"] = mapOf(
  ...
  "blueocean"                              to "io.jenkins.blueocean:blueocean:1.9.0",
  "blueocean-autofavorite"                 to "org.jenkins-ci.plugins:blueocean-autofavorite:1.2.2",
  "blueocean-bitbucket-pipeline"           to "io.jenkins.blueocean:blueocean-bitbucket-pipeline:1.9.0",
  "blueocean-commons"                      to "io.jenkins.blueocean:blueocean-commons:1.9.0",
  "blueocean-config"                       to "io.jenkins.blueocean:blueocean-config:1.9.0",
  "blueocean-core-js"                      to "io.jenkins.blueocean:blueocean-core-js:1.9.0",
  "blueocean-dashboard"                    to "io.jenkins.blueocean:blueocean-dashboard:1.9.0",
  "blueocean-display-url"                  to "org.jenkins-ci.plugins:blueocean-display-url:2.2.0",
  "blueocean-events"                       to "io.jenkins.blueocean:blueocean-events:1.9.0",
  "blueocean-git-pipeline"                 to "io.jenkins.blueocean:blueocean-git-pipeline:1.9.0",
  "blueocean-github-pipeline"              to "io.jenkins.blueocean:blueocean-github-pipeline:1.9.0",
  "blueocean-i18n"                         to "io.jenkins.blueocean:blueocean-i18n:1.9.0",
  "blueocean-jira"                         to "io.jenkins.blueocean:blueocean-jira:1.9.0",
  "blueocean-jwt"                          to "io.jenkins.blueocean:blueocean-jwt:1.9.0",
  "blueocean-personalization"              to "io.jenkins.blueocean:blueocean-personalization:1.9.0",
  "blueocean-pipeline-api-impl"            to "io.jenkins.blueocean:blueocean-pipeline-api-impl:1.9.0",
  "blueocean-pipeline-editor"              to "io.jenkins.blueocean:blueocean-pipeline-editor:1.9.0",
  "blueocean-pipeline-scm-api"             to "io.jenkins.blueocean:blueocean-pipeline-scm-api:1.9.0",
  "blueocean-rest"                         to "io.jenkins.blueocean:blueocean-rest:1.9.0",
  "blueocean-rest-impl"                    to "io.jenkins.blueocean:blueocean-rest-impl:1.9.0",
  "blueocean-web"                          to "io.jenkins.blueocean:blueocean-web:1.9.0",
  "bouncycastle-api"                       to "org.jenkins-ci.plugins:bouncycastle-api:2.17",
  "branch-api"                             to "org.jenkins-ci.plugins:branch-api:2.0.21",
  "build-timeout"                          to "org.jenkins-ci.plugins:build-timeout:1.19",
  "cloudbees-bitbucket-branch-source"      to "org.jenkins-ci.plugins:cloudbees-bitbucket-branch-source:2.2.14",
  "cloudbees-folder"                       to "org.jenkins-ci.plugins:cloudbees-folder:6.6",
  "command-launcher"                       to "org.jenkins-ci.plugins:command-launcher:1.2",
  "config-file-provider"                   to "org.jenkins-ci.plugins:config-file-provider:3.4.1",
  "credentials"                            to "org.jenkins-ci.plugins:credentials:2.1.18",
  "credentials-binding"                    to "org.jenkins-ci.plugins:credentials-binding:1.17",
  ...
  "durable-task"                           to "org.jenkins-ci.plugins:durable-task:1.28",
  "email-ext"                              to "org.jenkins-ci.plugins:email-ext:2.63",
  ...
  "git-client"                             to "org.jenkins-ci.plugins:git-client:2.7.3",
  "git-server"                             to "org.jenkins-ci.plugins:git-server:1.7",
  "github"                                 to "com.coravy.hudson.plugins.github:github:1.29.3",
  "github-api"                             to "org.jenkins-ci.plugins:github-api:1.92",
  "github-branch-source"                   to "org.jenkins-ci.plugins:github-branch-source:2.4.1",
  ...
  "htmlpublisher"                          to "org.jenkins-ci.plugins:htmlpublisher:1.17",
  "jackson2-api"                           to "org.jenkins-ci.plugins:jackson2-api:2.9.7.1",
  "jdk-tool"                               to "org.jenkins-ci.plugins:jdk-tool:1.1",
  "jenkins-design-language"                to "io.jenkins.blueocean:jenkins-design-language:1.9.0",
  "jira"                                   to "org.jenkins-ci.plugins:jira:3.0.5",
  "job-dsl"                                to "org.jenkins-ci.plugins:job-dsl:1.70",
  "jquery-detached"                        to "org.jenkins-ci.ui:jquery-detached:1.2.1",
  "jsch"                                   to "org.jenkins-ci.plugins:jsch:0.1.54.2",
  "junit"                                  to "org.jenkins-ci.plugins:junit:1.26.1",
  "kubernetes"                             to "org.csanchez.jenkins.plugins:kubernetes:1.13.5",
  "kubernetes-credentials"                 to "org.jenkinsci.plugins:kubernetes-credentials:0.4.0",
  "ldap"                                   to "org.jenkins-ci.plugins:ldap:1.20",
  "lockable-resources"                     to "org.6wind.jenkins:lockable-resources:2.3",
  "mailer"                                 to "org.jenkins-ci.plugins:mailer:1.22",
  "mapdb-api"                              to "org.jenkins-ci.plugins:mapdb-api:1.0.9.0",
  "matrix-auth"                            to "org.jenkins-ci.plugins:matrix-auth:2.3",
  "matrix-project"                         to "org.jenkins-ci.plugins:matrix-project:1.13",
  "mercurial"                              to "org.jenkins-ci.plugins:mercurial:2.4",
  "momentjs"                               to "org.jenkins-ci.ui:momentjs:1.1.1",
  "pam-auth"                               to "org.jenkins-ci.plugins:pam-auth:1.4",
  ...
  "pipeline-graph-analysis"                to "org.jenkins-ci.plugins:pipeline-graph-analysis:1.9",
  ...
  "pipeline-model-api"                     to "org.jenkinsci.plugins:pipeline-model-api:1.3.2",
  "pipeline-model-declarative-agent"       to "org.jenkinsci.plugins:pipeline-model-declarative-agent:1.1.1",
  "pipeline-model-definition"              to "org.jenkinsci.plugins:pipeline-model-definition:1.3.2",
  "pipeline-model-extensions"              to "org.jenkinsci.plugins:pipeline-model-extensions:1.3.2",
  ...
  "pipeline-stage-tags-metadata"           to "org.jenkinsci.plugins:pipeline-stage-tags-metadata:1.3.2",
  "pipeline-stage-view"                    to "org.jenkins-ci.plugins.pipeline-stage-view:pipeline-stage-view:2.10",
  "pipeline-utility-steps"                 to "org.jenkins-ci.plugins:pipeline-utility-steps:2.2.0",
  ...
  "scm-api"                                to "org.jenkins-ci.plugins:scm-api:2.3.0",
  "script-security"                        to "org.jenkins-ci.plugins:script-security:1.48",
  "sse-gateway"                            to "org.jenkins-ci.plugins:sse-gateway:1.16",
  "ssh-agent"                              to "org.jenkins-ci.plugins:ssh-agent:1.17",
  "ssh-credentials"                        to "org.jenkins-ci.plugins:ssh-credentials:1.14",
  "ssh-slaves"                             to "org.jenkins-ci.plugins:ssh-slaves:1.28.1",
  "structs"                                to "org.jenkins-ci.plugins:structs:1.17",
  ...
  "workflow-api"                           to "org.jenkins-ci.plugins.workflow:workflow-api:2.32",
  "workflow-basic-steps"                   to "org.jenkins-ci.plugins.workflow:workflow-basic-steps:2.12",
  "workflow-cps"                           to "org.jenkins-ci.plugins.workflow:workflow-cps:2.60",
  "workflow-cps-global-lib"                to "org.jenkins-ci.plugins.workflow:workflow-cps-global-lib:2.12",
  "workflow-durable-task-step"             to "org.jenkins-ci.plugins.workflow:workflow-durable-task-step:2.26",
  "workflow-job"                           to "org.jenkins-ci.plugins.workflow:workflow-job:2.29",
  "workflow-multibranch"                   to "org.jenkins-ci.plugins.workflow:workflow-multibranch:2.20",
  "workflow-scm-step"                      to "org.jenkins-ci.plugins.workflow:workflow-scm-step:2.7",
  "workflow-step-api"                      to "org.jenkins-ci.plugins.workflow:workflow-step-api:2.16",
  "workflow-support"                       to "org.jenkins-ci.plugins.workflow:workflow-support:2.22",
  "ws-cleanup"                             to "org.jenkins-ci.plugins:ws-cleanup:0.36"
)
