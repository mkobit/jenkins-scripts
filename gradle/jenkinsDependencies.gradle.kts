...
extra["jenkinsPluginArtifacts"] = mapOf(
  ...
  "kubernetes"                             to "org.csanchez.jenkins.plugins:kubernetes:1.5.1",
  ...
  "workflow-cps"                           to "org.jenkins-ci.plugins.workflow:workflow-cps:2.47",
  ...
  "workflow-job"                           to "org.jenkins-ci.plugins.workflow:workflow-job:2.18",
